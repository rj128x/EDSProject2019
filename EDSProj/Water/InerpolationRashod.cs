...
namespace EDSProj
{
	public class InerpolationRashod
	{
		...
		public static double getPower(int ga, double rashod, double napor) {
			double p = 0;
			while (p < 115) {
				double q = getRashodGA(ga, p, napor);
				if (q > rashod)
					break;
				p += 1;
			}
			...
			double p1 = p - 1;
			while (p1 < p+1) {
				double q = getRashodGA(ga, p1, napor);
				if (q > rashod)
					break;
				p1 += 0.001;
			}
		...
		public static double getPowerGES(double rashod, double napor) {
			double p = 0;
			while (p < 1100) {
				double q = OptimRashod.getOptimRashod(p,napor);
				if (q > rashod)
					break;
				p += 1;
			}
			...
			double p1 = p - 1;
			while (p1 < p + 1) {
				double q = OptimRashod.getOptimRashod(p1, napor);
				if (q > rashod)
					break;
				p1 += 0.001;
			}
